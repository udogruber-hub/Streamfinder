  ...
  const HELP={
    ...
    history:{
      ...
      items:[
        ...
        {icon:"🚫",title:"Blockierte Titel",text:"Alle ausgeblendeten Titel. Tippe auf einen um ihn wieder zu sehen."},
...
function MainApp({profile:initProfile,onReset}){
  ...
  function applyMood(mood){
    ...
    setFeedLoading(true);
    setHeroItems([]);setFeedItems([]);
    Promise.all([
      discoverTitles("serie",moodIds,genreStr,1,"vote_average.desc"),
      discoverTitles("film",moodIds,genreStr,1,"vote_average.desc"),
      discoverTitles("serie",moodIds,genreStr,2,"popularity.desc"),
      discoverTitles("film",moodIds,genreStr,2,"popularity.desc"),
    ]).then(([s1,f1,s2,f2])=>{
      const all=[
