  ...
  return(
    <div style={{display:"flex",flexDirection:"column"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:8,padding:"0 12px 8px"}}>
        ...
        {/* Stimmungs-Empfehlungen — unter den Extras */}
        {!activeFeature&&(stimmungRecs.length>0||stimmungLoading)&&(
          <div style={{marginTop:8}}>
            <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:10}}>
              <div style={{flex:1,height:1,background:"linear-gradient(90deg,rgba(196,169,96,0.3),transparent)"}}/>
              <span style={{fontSize:10,color:"#c4a960",fontWeight:700,letterSpacing:"1.5px",textTransform:"uppercase",fontFamily:"'DM Sans'"}}>Für dich heute</span>
              ...
              {stimmungRecs.map((it,i)=>(
                <SwipeToBlock key={it.id||i} onBlock={()=>{
                  setStimmungRecs(prev=>{
                    ...
                    if(stimmungReserve.length>0){
                      const [next,...rest]=stimmungReserve;
                      setStimmungReserve(rest);
