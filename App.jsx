      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",gap:8,padding:"0 12px 8px",minHeight:0}}>
        ...
        <button onClick={()=>setActiveFeature("deepdive")}
          ...
          <div style={{position:"relative",padding:"16px 18px",height:"100%",display:"flex",flexDirection:"column",justifyContent:"space-between"}}>
            ...
            {/* Bottom: Text */}
            <div>
              <div style={{fontSize:20,fontWeight:900,color:"#ffffff",marginBottom:6,letterSpacing:"-0.3px",textShadow:"0 2px 8px rgba(0,0,0,0.5)"}}>{tiles[0].title}</div>
              <div style={{fontSize:13,color:"rgba(255,255,255,0.7)",lineHeight:1.5,textShadow:"0 1px 4px rgba(0,0,0,0.8)"}}>{tiles[0].hint}</div>
            </div>
          </div>
          {/* Arrow */}
          ...
          {tiles.slice(1).map((t,ri)=>(
            <button key={t.id} onClick={()=>setActiveFeature(t.id)}
              ...
              <div style={{position:"relative",padding:"14px 12px",height:"100%",display:"flex",flexDirection:"column",justifyContent:"space-between"}}>
                ...
                <div>
                  <div style={{fontSize:14,fontWeight:800,color:"#ffffff",marginBottom:4,textShadow:"0 2px 6px rgba(0,0,0,0.6)"}}>{t.title}</div>
                  <div style={{fontSize:10,color:"rgba(255,255,255,0.6)",lineHeight:1.4,textShadow:"0 1px 4px rgba(0,0,0,0.8)"}}>{t.hint}</div>
                </div>
              </div>
            </button>
          ))}
          ...
          {extras.map((e,ei)=>{
            ...
            return(
              <button key={e.id} onClick={()=>setActiveFeature(e.id)}
                ...
                <div>
                  <div style={{fontSize:10,fontWeight:800,color:"#e0d8e8",lineHeight:1.3,marginBottom:3}}>{e.title}</div>
                  <div style={{fontSize:8,color:"rgba(255,255,255,0.35)",lineHeight:1.3}}>{e.hint}</div>
                </div>
              </button>
            );
          })}
