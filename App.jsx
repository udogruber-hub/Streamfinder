    ...
    <div style={{maxWidth:820,margin:"0 auto",minHeight:"100vh",background:"#09090f",position:"relative",fontFamily:"'DM Sans',sans-serif"}}>
      ...
      <div style={{position:"sticky",top:0,zIndex:100,background:"rgba(9,9,15,0.92)",backdropFilter:"blur(20px)",borderBottom:"1px solid rgba(255,255,255,0.05)",padding:"10px 18px",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
        ...
        <div style={{display:"flex",gap:6}}>
          <button onClick={()=>{setShowHelp(true);setShowHelpHint(false);try{localStorage.setItem('sf_help_hint_seen','1');}catch{}}} style={{width:34,height:34,borderRadius:10,background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.1)",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",color:"#b0a8b8",fontSize:16,fontWeight:700}}>?</button>
      ...
      {/* Erster-Start Hinweis auf ? Button */}
      {showHelpHint&&(
        <div onClick={()=>setShowHelpHint(false)} style={{position:"fixed",top:64,right:12,zIndex:150,animation:"fadeIn 0.4s ease"}}>
          <div style={{background:"linear-gradient(135deg,#1a1528,#12101e)",border:"1px solid rgba(196,169,96,0.4)",borderRadius:14,padding:"10px 14px",maxWidth:200,boxShadow:"0 8px 24px rgba(0,0,0,0.6)"}}>
            <div style={{position:"absolute",top:-6,right:14,width:12,height:12,background:"#1a1528",border:"1px solid rgba(196,169,96,0.4)",borderBottom:"none",borderRight:"none",transform:"rotate(45deg)"}}/>
            <p style={{fontSize:12,color:"#c4a960",fontWeight:700,margin:"0 0 3px"}}>💡 Neu hier?</p>
            <p style={{fontSize:11,color:"#b0a8b8",margin:0,lineHeight:1.4}}>Tippe das <strong style={{color:"#f0ece4"}}>?</strong> für eine schnelle Einführung.</p>
          </div>
        </div>
      )}
      {/* Content */}
