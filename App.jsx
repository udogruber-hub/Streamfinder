...
function MainApp({initialProfile}){
  ...
  return(
    <div style={{maxWidth:820,margin:"0 auto",minHeight:"100vh",background:"#09090f",position:"relative",fontFamily:"'DM Sans',sans-serif"}}>
      ...
      <div style={{background:"rgba(196,169,96,0.06)",borderBottom:"1px solid rgba(196,169,96,0.1)",padding:"5px 16px",display:"flex",alignItems:"center",justifyContent:"center",gap:6}}>
