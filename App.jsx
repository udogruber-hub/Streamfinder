        ...
        <div style={{flexShrink:0,padding:"0 12px 8px"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            {stimmungRecs.map((it,i)=>(
              <SwipeToBlock key={it.id||i} onBlock={()=>setStimmungRecs(prev=>prev.filter((_,j)=>j!==i))}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:8,padding:"0 12px 8px"}}>
        ...
        {!activeFeature&&(
          <div style={{display:"flex",alignItems:"center",gap:10,padding:"4px 2px"}}>
            ...
            <span style={{fontSize:10,color:"#c4a960",fontWeight:700,letterSpacing:"1.5px",textTransform:"uppercase",fontFamily:"'DM Sans'"}}>KI-Funktionen</span>
