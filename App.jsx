...
// Genre-Bilder: bekannte funktionierende TMDB-Poster per Genre-ID
const GENRE_IMAGES={
  28:"https://image.tmdb.org/t/p/w500/9n2tJBplPbgR2ca05hS5CKXwP2c.jpg",   // Action: Mad Max
  35:"https://image.tmdb.org/t/p/w500/uLTVAfKa0Ac9SETpZhHlFGWFVZU.jpg",   // Komödie: The Hangover
  53:"https://image.tmdb.org/t/p/w500/44immBwzhDVyjn87b3x3l9mlhAD.jpg",   // Thriller
  18:"https://image.tmdb.org/t/p/w500/q6y0Go1tsGEsmtFryDOJo3dEmqu.jpg",   // Drama: Shawshank
  27:"https://image.tmdb.org/t/p/w500/vL5LR6WdxWPjLPFRLe133jXWsh5.jpg",   // Horror: The Shining
  878:"https://image.tmdb.org/t/p/w500/1pdfLvkbY9ohJlCjQH2CZjjYVvJ.jpg",  // Sci-Fi: Arrival
  14:"https://image.tmdb.org/t/p/w500/56v2KjBlU4XaOv9rVYEQypROD7P.jpg",   // Fantasy: LotR
  9648:"https://image.tmdb.org/t/p/w500/aojtAyGdVKOvQ3BGPPV0MB6vWON.jpg", // Mystery: Gone Girl
  99:"https://image.tmdb.org/t/p/w500/z1p34vh7dEOnLDmyCrlUVLuoDzd.jpg",   // Doku
  10749:"https://image.tmdb.org/t/p/w500/kucXaqAIDObJWleGzxCvWlhaaYj.jpg", // Romantik: Notebook
  80:"https://image.tmdb.org/t/p/w500/ggFHVNu6YYI5L9pCfOacjizRGt.jpg",   // Krimi
  12:"https://image.tmdb.org/t/p/w500/ceG9VzoRAVGwivFU403Wc3AHRys.jpg",   // Abenteuer: Indiana Jones
};
            ...
            {STIMMUNGEN.map(m=>{
              ...
              return(
                <button key={m.id} onClick={()=>{if(m.id===activeStimmung){setActiveStimmung(null);setStimmungRecs([]);return;}setActiveStimmung(m.id);activeStimmungRef.current=m.id;try{localStorage.setItem('sf_active_stimmung',m.id);}catch{}loadStimmungRecs(m);}}
                  ...
                  <img src={GENRE_IMAGES[m.genres[0]]||""} alt="" style={{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"center 20%",opacity:active?0.7:0.4,transition:"opacity 0.25s"}} onError={e=>{e.target.style.display="none";}}/>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8}}>
            {STIMMUNGEN.map(m=>{
              ...
              return(<button key={m.id} onClick={()=>toggleStimmung(m.id)} style={{position:"relative",borderRadius:16,overflow:"hidden",cursor:"pointer",border:"2px solid "+(sel?m.color:"transparent"),transition:"all 0.2s",height:90,background:"#0a0a12",boxShadow:sel?"0 0 24px "+m.color+"50":"none",padding:0}}>
                <img src={GENRE_IMAGES[m.genres[0]]||""} alt="" style={{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"center 20%",opacity:sel?0.75:0.35,transition:"opacity 0.2s"}} onError={e=>{e.target.style.display="none";}}/>
