      ...
      <div style={{minHeight:100,maxHeight:300,overflow:"auto",marginBottom:12,display:"flex",flexDirection:"column",gap:8}}>
        ...
        {botMessages.map((m,i)=>(
            ...
            {m.text==="__RATE_LIMIT__"
              ...
              :<div style={{background:m.role==="user"?"linear-gradient(135deg,#e84393,#ff6b35)":"#1a1a2e",borderRadius:12,padding:"10px 14px",maxWidth:"85%",fontSize:13,color:"#f0ece4",lineHeight:1.5}}>{m.text}</div>
            }
          </div>
        ))}
...
function SpotlightTab({profile,cardProps,onSelect}){
  ...
  const tiles=[
    {id:"deepdive",title:"Sag mir was mir gefällt…",hint:"Sag mir was du schaust — ich sag dir was dir gefällt",color:"#c4a960",accentGrad:"linear-gradient(90deg,#c4a960,#ff6b35)"},
    {id:"vibe",title:"Vibe-Meter",hint:"Stimmung einstellen → perfekter Titel",color:"#e84393",accentGrad:"linear-gradient(90deg,#e84393,#c026d3)"},
    {id:"bot",title:"Frag den Popcorn-Guru",hint:"Dein persönlicher Experte antwortet",color:"#4ade80",accentGrad:"linear-gradient(90deg,#4ade80,#22d3ee)"},
  ];
