...
function HelpModal({onClose,activeTab}){
  ...
  const HELP={
    ...
    spotlight:{
      ...
      items:[
        {icon:"🔭",title:"Sag mir was mir gefällt…",text:"Gib einen Lieblingstitel ein — die KI baut ein ganzes Entdeckungs-Universum: ähnliche Titel, gleiche Energie, versteckte Perlen. Tipp: Breaking Bad, Inception oder Peaky Blinders als Startpunkt."},
