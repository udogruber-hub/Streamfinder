    ...
    <div style={{borderRadius:24,overflow:"hidden",border:"1px solid #1e1e30",marginBottom:14,cursor:"pointer"}} onClick={()=>onSelect(item)}>
      ...
      <div style={{background:"linear-gradient(145deg,#13121f,#0f0e1a)",padding:"14px 16px"}}>
        ...
        <div style={{display:"flex",gap:6,marginTop:12,flexWrap:"wrap"}}>
          ...
          <button onClick={e=>{e.stopPropagation();onBlock(title);}} style={{padding:"9px 10px",borderRadius:12,background:"#1a1a2e",border:"1px solid #2a2340",color:"#666",cursor:"pointer",fontFamily:"'DM Sans'",fontWeight:600,fontSize:10}} title="Interessiert mich nicht — nie wieder empfehlen">✕</button>
        </div>
      </div>
    </div>
  );
