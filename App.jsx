    ...
    const platCandidates=await Promise.all(userPlats.map(async(plat,pi)=>{
      try{
        ...
        const similarForPlat=similarPool.filter(r=>{
          ...
          return myRating!==1&&(r.vote_average||0)>=6.0;
        });
...
Priorisiere ähnliche Titel! Nur aus Kandidaten wählen.`;
      ...
      try{
        ...
        if(kiErr?.message?.includes("429")||kiErr?.message?.includes("rate")||kiErr?.message?.includes("RATE"))setRateLimited(true);
...
const STIMMUNGEN=[
  ...
  {id:"drama",     label:"Drama",         color:"#e84393", genres:[18],    tmdbImg:"https://image.tmdb.org/t/p/w500/q6y0Go1tsGEsmtFryDOJo3dEmquYsLeMMovMAKAg.jpg"},
  {id:"horror",    label:"Horror",        color:"#6366f1", genres:[27],    tmdbImg:"https://image.tmdb.org/t/p/w500/wTnV3PCVW5O92JMrFvvrRcV39RU.jpg"},
  {id:"scifi",     label:"Sci-Fi",        color:"#a78bfa", genres:[878],   tmdbImg:"https://image.tmdb.org/t/p/w500/d5NXSklpcvkD173vtvzrmOd4UPq3vtvzrmOd4UPq.jpg"},
  {id:"fantasy",   label:"Fantasy",       color:"#4ade80", genres:[14],    tmdbImg:"https://image.tmdb.org/t/p/w500/56v2KjBlU4XaOv9rVYEQypROD7P.jpg"},
  {id:"mystery",   label:"Mystery",       color:"#22d3ee", genres:[9648],  tmdbImg:"https://image.tmdb.org/t/p/w500/pThyQovXQrwlyFk9zKn8XdnZoKGGD4y8lVMZXyfI.jpg"},
  {id:"doku",      label:"Doku",          color:"#34d399", genres:[99],    tmdbImg:"https://image.tmdb.org/t/p/w500/z1p34vh7dEOnLDmyCrlUVLuoDzd.jpg"},
  {id:"romance",   label:"Romantik",      color:"#f472b6", genres:[10749], tmdbImg:"https://image.tmdb.org/t/p/w500/uDO8zWDhfWwoFdKS4fzkUJt0RfK50sbH0s4YjEc.jpg"},
