...
function PlatformCard({platform,profile,onSelect,onBlock,onLike,onRate,browseType}){
  ...
  useEffect(()=>{
    ...
    // Nach Universal Swipe → Top5 neu laden wenn offen
...
Schreibe eine kurze Zusammenfassung des Geschmacks auf Deutsch (1 Satz).`;
  ...
  async function handleDone(){
    ...
    // Signal: Profil hat sich stark verändert → alles neu laden
  ...
  if(done||idx>=items.length)return(
    <div style={{textAlign:"center",padding:40}}>
      ...
      <p style={{fontSize:12,color:"#b0a8b8",marginBottom:20}}>Deine Empfehlungen werden jetzt angepasst.</p>
