      ...
      {open&&(
        <div style={{padding:"0 14px 16px"}}>
          ...
          {!loading&&recs&&(()=>{
            ...
            // Sortierung: KI-Score wenn vorhanden, sonst TMDB-Rating
            ...
            const scoreColor=score>=8?"#4ade80":score>=7?"#fbbf24":"#fb923c";
            // % Übereinstimmung — nur anzeigen wenn genug Bewertungen
            const ratingCount=Object.keys(profile.ratings||{}).length;
            const hasKIScore=!!rec.score;
            const hasEnoughData=hasKIScore||ratingCount>=5;
                    ...
                    <div style={{position:"absolute",inset:0,display:"flex",alignItems:"center",gap:12,padding:"0 14px"}}>
                      ...
                      <div style={{display:"flex",flexDirection:"column",alignItems:"center",flexShrink:0,width:32,gap:2}}>
                        ...
                        {hasEnoughData
                          ...
                          :<span style={{fontSize:7,color:"#3a3350",fontFamily:"'DM Sans'",lineHeight:1.2,textAlign:"center"}}>noch{"
"}wenig{"
"}Daten</span>
                        }
                      </div>
