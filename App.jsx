    ...
    <div style={{background:"#12121f",borderRadius:18,overflow:"hidden",border:"1px solid #1e1e30",marginBottom:10}}>
      <div style={{padding:"14px 16px",display:"flex",alignItems:"center",gap:12}}>
        ...
        <div style={{display:"flex",gap:6}}>
          <button onClick={()=>handleMode("top5")} style={{background:mode==="top5"?"rgba(255,107,53,0.13)":"#1a1a2e",border:mode==="top5"?"1px solid rgba(255,107,53,0.27)":"1px solid #2a2340",borderRadius:10,padding:"7px 10px",color:mode==="top5"?"#ff6b35":"#b0a8b8",cursor:"pointer",fontSize:11,fontFamily:"'DM Sans'",fontWeight:700}}>🎯 Top 5</button>
