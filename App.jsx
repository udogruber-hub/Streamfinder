  ...
  return(
    <div style={{display:"flex",flexDirection:"column"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:8,padding:"0 12px 8px"}}>
                ...
                {/* Witzige Überschrift über KI-Funktionen */}
        {!activeFeature&&(
          <div style={{padding:"4px 2px 8px",display:"flex",alignItems:"center",gap:10}}>
            <div style={{flex:1,height:1,background:"linear-gradient(90deg,rgba(124,58,237,0.3),transparent)"}}/>
            <span style={{fontSize:10,color:"#9f7dea",fontWeight:700,letterSpacing:"1px",textTransform:"uppercase",fontFamily:"'DM Sans'",whiteSpace:"nowrap"}}>
              Frisch. Persönlich. Nur für heute Abend. ✨
            </span>
            <div style={{flex:1,height:1,background:"linear-gradient(90deg,transparent,rgba(124,58,237,0.3))"}}/>
          </div>
        )}
...
{/* Stimmungsleiste — Premium Poster Grid */}
        {!activeFeature&&(
          <div style={{flexShrink:0,marginBottom:4}}>
            <p style={{fontSize:10,color:"#5a5468",margin:"0 0 10px",letterSpacing:"0.8px",textTransform:"uppercase",paddingLeft:2}}>Was schaust du heute?</p>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:8}}>
                ...
                {stimmungRecs.slice(0,3).map((it,i)=>(
                  <SwipeToBlock key={it.id||i} onBlock={async()=>{
                    ...
                    // Wenn Reserve leer — TMDB Fallback
                    if(recReserve.current.length===0){
                      try{
                        const allIds=(profile.platforms||[]).flatMap(id=>PLATFORMS.find(p=>p.id===id)?.tmdbIds||[]);
                        ...
                        const fresh=(r.results||[]).filter(it=>!shownTitles.current.has(it.id)&&(it.vote_average||0)>=7.0);
                        fresh.slice(0,5).forEach(it=>shownTitles.current.add(it.id));
                        recReserve.current=fresh.slice(1,5).map(it=>({...it,media_type:"movie"}));
                        if(fresh.length>0){
                          setStimmungRecs(prev=>{
                            const withNew=[...prev,{...fresh[0],media_type:"movie"}];
                            if(activeStimmung&&stimmungCache.current[activeStimmung]){
...
const STIMMUNGEN=[
  {id:"action",    label:"Action",          color:"#ff6b35", genres:[28],    tmdbImg:"https://image.tmdb.org/t/p/w500/qJ2tW6WMUDux911r6m7haRef0WH.jpg"},
  {id:"comedy",    label:"Komödie",         color:"#f59e0b", genres:[35],    tmdbImg:"https://image.tmdb.org/t/p/w500/pB8BM7pdSp6B6Ih7QZ4DrQ3PmJK.jpg"},
  {id:"thriller",  label:"Thriller",        color:"#ef4444", genres:[53],    tmdbImg:"https://image.tmdb.org/t/p/w500/qNBAXBIQlnOThrVvA6mA2B5ggkl.jpg"},
  {id:"drama",     label:"Drama",           color:"#e84393", genres:[18],    tmdbImg:"https://image.tmdb.org/t/p/w500/3bhkrj58Vtu7enYsLeMMovMAKAg.jpg"},
  {id:"horror",    label:"Horror",          color:"#6366f1", genres:[27],    tmdbImg:"https://image.tmdb.org/t/p/w500/ArZ5bAkOSBHFYYQH4UrVQm4KVOM.jpg"},
  ...
  {id:"mystery",   label:"Mystery",         color:"#22d3ee", genres:[9648],  tmdbImg:"https://image.tmdb.org/t/p/w500/cWUOv3H7YFwvKeaQhoAQTLLpo9Z.jpg"},
  {id:"doku",      label:"Dokumentation",   color:"#34d399", genres:[99],    tmdbImg:"https://image.tmdb.org/t/p/w500/2zl7HBCkmqZXYnXNWVTqX7oFkbb.jpg"},
  {id:"romance",   label:"Romantik",        color:"#f472b6", genres:[10749], tmdbImg:"https://image.tmdb.org/t/p/w500/rSPw7tgCH9c6NqICZef4kZjFOQ5.jpg"},
  {id:"krimi",     label:"Krimi",           color:"#fb923c", genres:[80],    tmdbImg:"https://image.tmdb.org/t/p/w500/qNBAXBIQlnOThrVvA6mA2B5ggkl.jpg"},
      ...
      <div style={{minHeight:"100vh",background:"#09090f",fontFamily:"'DM Sans',sans-serif",display:"flex",flexDirection:"column"}}>
        ...
        {!swipeLoading&&cur&&(
          <div style={{flex:1,display:"flex",flexDirection:"column",padding:"12px 20px 20px",maxWidth:440,margin:"0 auto",width:"100%",minHeight:0}}>
            ...
            <div style={{borderRadius:20,overflow:"hidden",position:"relative",background:"#0a0a12",flexShrink:0}}>
              {cur.backdrop_path
                ?<img src={"https://image.tmdb.org/t/p/w780"+cur.backdrop_path} alt="" style={{width:"100%",height:"auto",display:"block",minHeight:200}}/>
                :cur.poster_path
                  ?<img src={"https://image.tmdb.org/t/p/w500"+cur.poster_path} alt="" style={{width:"100%",height:"auto",display:"block",minHeight:200}}/>
                  :<div style={{width:"100%",height:220,display:"flex",alignItems:"center",justifyContent:"center",fontSize:60}}>🎬</div>}
