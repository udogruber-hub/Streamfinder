  ...
  if(step===0){
    ...
    return(
      <div style={{height:"100vh",maxHeight:"-webkit-fill-available",background:"#09090f",display:"flex",flexDirection:"column",position:"relative",overflow:"hidden"}}>
        {/* Filmbild */}
        <img src={heroImg} alt="" style={{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"center 25%"}} onError={e=>{e.target.style.display="none";}}/>
        {/* Film-Grain Overlay für Kinoatmosphäre */}
