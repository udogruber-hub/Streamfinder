...
// ── STIMMUNGEN mit korrekten TMDB-Bildern ──
const STIMMUNGEN=[
  {id:"action",    label:"Action",        color:"#ff6b35", genres:[28],    tmdbImg:"https://image.tmdb.org/t/p/w780/8Y43POKjjKDGI9MH89NW0NAzzp8.jpg"},
  {id:"comedy",    label:"Komödie",       color:"#f59e0b", genres:[35],    tmdbImg:"https://image.tmdb.org/t/p/w780/qem4FNfj0iYr5TDlvTIXwWFKyVz.jpg"},
  {id:"thriller",  label:"Thriller",      color:"#ef4444", genres:[53],    tmdbImg:"https://image.tmdb.org/t/p/w780/suaEOtk1N1sgg2MTM7oZd2cfVp3.jpg"},
  {id:"drama",     label:"Drama",         color:"#e84393", genres:[18],    tmdbImg:"https://image.tmdb.org/t/p/w780/3bhkrj58Vtu7enYsLeMMovMAKAg.jpg"},
  {id:"horror",    label:"Horror",        color:"#6366f1", genres:[27],    tmdbImg:"https://image.tmdb.org/t/p/w780/ArZ5bAkOSBHFYYQH4UrVQm4KVOM.jpg"},
  {id:"scifi",     label:"Sci-Fi",        color:"#a78bfa", genres:[878],   tmdbImg:"https://image.tmdb.org/t/p/w780/xJHokMbljvjADYdit5fK5VQsXEG.jpg"},
  {id:"fantasy",   label:"Fantasy",       color:"#4ade80", genres:[14],    tmdbImg:"https://image.tmdb.org/t/p/w780/56v2KjBlU4XaOv9rVYEQypROD7P.jpg"},
  {id:"mystery",   label:"Mystery",       color:"#22d3ee", genres:[9648],  tmdbImg:"https://image.tmdb.org/t/p/w780/gMJngTNfaqCSCqGD4y8lVMZXyfI.jpg"},
  {id:"doku",      label:"Dokumentation", color:"#34d399", genres:[99],    tmdbImg:"https://image.tmdb.org/t/p/w780/2zl7HBCkmqZXYnXNWVTqX7oFkbb.jpg"},
  {id:"romance",   label:"Romantik",      color:"#f472b6", genres:[10749], tmdbImg:"https://image.tmdb.org/t/p/w780/hSaH9tt67bozo9K50sbH0s4YjEc.jpg"},
  {id:"krimi",     label:"Krimi",         color:"#fb923c", genres:[80],    tmdbImg:"https://image.tmdb.org/t/p/w780/d5NXSklpcvkD173vtvzrmOd4UPq.jpg"},
  {id:"abenteuer", label:"Abenteuer",     color:"#60a5fa", genres:[12],    tmdbImg:"https://image.tmdb.org/t/p/w780/gEU2QniE6E77NI6lCU6MxlNBvIx.jpg"},
];
...
function BrowseTab({profile,cardProps,onSelect,onSwipe,onWatched}){
  ...
  useEffect(()=>{
    ...
    return()=>window.removeEventListener("sf_open_swipe",onOpenSwipe);
  },[]);
...
function Onboarding({onDone}){
  ...
  function finish(){
    ...
    const profile={platforms:selPlats,genres,ratings:{},liked:[],liked_items:[],watched:[],blocked_titles:[],languages:[]};
  ...
  const steps=[
    ...
    {title:"Los geht's!",sub:"StreamFinder ist bereit"},
  ];
  const s=steps[step];
    ...
    <div style={{minHeight:"100vh",background:"linear-gradient(180deg,#09090f,#0d0d1a)",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{flex:1,padding:"0 20px 24px",overflowY:"auto"}}>
        ...
        {step===3&&(
          <div style={{textAlign:"center",paddingTop:20}}>
            ...
            <h2 style={{fontFamily:"'Instrument Serif',serif",fontSize:28,color:"#f0ece4",marginBottom:12}}>Bereit!</h2>
            <div style={{background:"#12121f",borderRadius:16,padding:"14px 16px",border:"1px solid #1e1e30",marginBottom:16,textAlign:"left"}}>
              <p style={{fontSize:12,color:"#7a7488",fontWeight:700,textTransform:"uppercase",letterSpacing:0.5,margin:"0 0 8px"}}>Zusammenfassung</p>
            ...
            <p style={{fontSize:12,color:"#555",lineHeight:1.5}}>Du kannst alles jederzeit im Profil anpassen.</p>
          </div>
        )}
      </div>
      ...
      <div style={{padding:"16px 20px 32px",display:"flex",gap:10}}>
        ...
        <button onClick={()=>step<steps.length-1?setStep(s=>s+1):finish()}
          ...
          {step<steps.length-1?"Weiter →":"StreamFinder starten 🚀"}
        </button>
      </div>

      <div style={{display:"flex",gap:4,justifyContent:"center",paddingBottom:16}}>
