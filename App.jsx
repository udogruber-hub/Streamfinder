          ...
          <div style={{flexShrink:0,marginBottom:4}}>
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
              ...
              <button onClick={()=>setGenreExpanded(v=>!v)}
                ...
                <span style={{fontSize:10,color:"#7a7488",fontFamily:"'DM Sans'",fontWeight:600}}>{genreExpanded?"Weniger":"Alle 12"}</span>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:8,overflow:"hidden",maxHeight:genreExpanded?"500px":"176px",transition:"max-height 0.35s ease"}}>
              {STIMMUNGEN.map(m=>{
