    ...
    <div onClick={()=>onSelect(item)} style={{background:"#12121f",borderRadius:18,overflow:"hidden",border:"1px solid #1e1e30",marginBottom:8,cursor:"pointer"}}>
      <div style={{padding:14,display:"flex",gap:12,alignItems:"flex-start"}}>
        ...
        <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:6,flexShrink:0}}>
          ...
          <button onClick={e=>{e.stopPropagation();onBlock(title);}} title="Interessiert mich nicht"
            style={{background:"transparent",border:"1px solid #2a2340",borderRadius:8,width:28,height:28,cursor:"pointer",color:"#555",fontSize:12,display:"flex",alignItems:"center",justifyContent:"center",lineHeight:1}}>✕</button>
        </div>
      </div>
    </div>
  );
