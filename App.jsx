...
function MainApp({profile:initProfile,onReset}){
  ...
  const [baseHeroItems,setBaseHeroItems]=useState([]); // Original-Liste — nie überschreiben
  const [baseFeedItems,setBaseFeedItems]=useState([]); // Original-Liste — nie überschreiben
  ...
  async function loadHomeFeed(){
    ...
    try{
      ...
      setHeroItems(hero);
      setFeedItems(feed);
      setBaseHeroItems(hero);  // Original speichern
      setBaseFeedItems(feed);  // Original speichern
