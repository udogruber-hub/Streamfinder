...
function OnboardingQuiz(props) {
  ...
  var refTitles = [
    ...
    { title: "Friends", emoji: "☕" },
    { title: "Game of Thrones", emoji: "⚔️" },
    { title: "Stranger Things", emoji: "👻" },
    { title: "The Office", emoji: "😂" },
    { title: "Dark", emoji: "🌀" },
    { title: "Squid Game", emoji: "🎮" },
    { title: "Bridgerton", emoji: "💕" },
    { title: "True Detective", emoji: "🔍" },
    { title: "Our Planet", emoji: "🌍" },
    { title: "The Boys", emoji: "💥" },
    { title: "Fleabag", emoji: "🍸" },
    { title: "Interstellar", emoji: "🚀" },
    { title: "Inception", emoji: "🌀" },
    { title: "The Shawshank Redemption", emoji: "🔒" },
    { title: "Parasite", emoji: "🏠" },
    { title: "The Mandalorian", emoji: "🪖" },
    { title: "Succession", emoji: "💼" },
    { title: "Wednesday", emoji: "🖤" },
    { title: "Chernobyl", emoji: "☢️" },
  ];
  ...
  function finish() {
    ...
    Object.keys(ratings).forEach(function(title) {
      if (ratings[title] === "love") loved.push(title);
      if (ratings[title] === "nope") hated.push(title);
    });

    // Ask AI to analyze taste profile
    var prompt = "Analysiere den Filmgeschmack. Der User liebt: " + (loved.join(", ") || "keine Angabe") +
      ". Der User mag nicht: " + (hated.join(", ") || "keine Angabe") +
      ". Antworte NUR mit JSON: {\"profile\": \"kurze Beschreibung des Geschmacks auf Deutsch (1-2 Sätze)\", \"genres\": [Liste der TMDB Genre-IDs als Zahlen die der User mag], \"avoid_genres\": [Genre-IDs die vermieden werden sollten]}. Nur JSON.";
    ...
    askClaude(prompt).then(function(text) {
      try {
        ...
        var genreScores = {};
        (analysis.genres || []).forEach(function(g) { genreScores[g] = 5; });
        (analysis.avoid_genres || []).forEach(function(g) { genreScores[g] = -3; });

        onComplete({
          platforms: plats,
          genres: genreScores,
          tasteProfile: analysis.profile || "",
          lovedTitles: loved,
          hatedTitles: hated,
          liked: [],
          disliked: [],
  ...
  if (analyzing) {
    return (
      <div style={{ minHeight: "100vh", background: "linear-gradient(180deg, #121018, #0d0b14)", color: "#f0ece4", fontFamily: "'DM Sans', sans-serif", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 20 }}>
        ...
        <h2 style={{ fontFamily: "'Instrument Serif', serif", fontSize: 26, marginBottom: 8 }}>Analysiere deinen Geschmack...</h2>
        <p style={{ color: "#8a7e6e", fontSize: 15 }}>Die KI lernt, was du magst</p>
