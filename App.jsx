...
function Onboarding({onDone}){
  ...
  function goToSwipe(){
    ...
    sSet("sf_profile",profile);
    setShowStartSwipe(true);
  }
    ...
    return(
      <div style={{minHeight:"100vh",background:"#09090f",display:"flex",flexDirection:"column"}}>
        <div style={{padding:"20px 18px 0",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          <span style={{fontFamily:"'Instrument Serif',serif",fontSize:20,background:"linear-gradient(135deg,#c4a960,#f5e090)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>StreamFinder</span>
          <button onClick={skipSwipe} style={{background:"none",border:"none",color:"#555",cursor:"pointer",fontSize:13,fontFamily:"'DM Sans'"}}>Überspringen →</button>
        </div>
        <div style={{padding:"16px 18px 8px"}}>
          <h2 style={{fontFamily:"'Instrument Serif',serif",fontSize:26,color:"#f0ece4",margin:"0 0 4px"}}>Erster Eindruck 🎴</h2>
          <p style={{fontSize:13,color:"#7a7488",margin:0}}>Swipe durch Titel — StreamFinder lernt deinen Geschmack.</p>
        </div>
  ...
  return(
    <div style={{minHeight:"100vh",background:"#09090f",display:"flex",flexDirection:"column",overflow:"hidden"}}>
      {/* Animated background */}
      <div style={{position:"fixed",inset:0,pointerEvents:"none",zIndex:0}}>
        <div style={{position:"absolute",top:"-20%",left:"-10%",width:"60%",height:"60%",borderRadius:"50%",background:"radial-gradient(circle,rgba(124,58,237,0.15) 0%,transparent 70%)"}}/>
        <div style={{position:"absolute",bottom:"-10%",right:"-10%",width:"50%",height:"50%",borderRadius:"50%",background:"radial-gradient(circle,rgba(232,67,147,0.12) 0%,transparent 70%)"}}/>
      </div>
      ...
      <div style={{position:"relative",zIndex:1,flex:1,display:"flex",flexDirection:"column"}}>
        ...
        {step===0&&(
          <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"40px 28px 24px",textAlign:"center"}}>
            <div style={{width:88,height:88,borderRadius:28,background:"linear-gradient(135deg,#7c3aed,#e84393)",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 20px",boxShadow:"0 12px 48px rgba(124,58,237,0.5)"}}>
              <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>
            </div>
            <h1 style={{fontFamily:"'Instrument Serif',serif",fontSize:42,margin:"0 0 8px",background:"linear-gradient(135deg,#c4a960,#f5e090)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",lineHeight:1.1}}>StreamFinder</h1>
            <p style={{fontSize:16,color:"#7a7488",margin:"0 0 40px",lineHeight:1.5}}>Dein persönlicher KI-Streaming-Assistent</p>
            <div style={{width:"100%",display:"flex",flexDirection:"column",gap:10,marginBottom:32}}>
              {[
                {grad:"linear-gradient(135deg,#7c3aed22,#7c3aed11)",border:"rgba(124,58,237,0.25)",icon:"✨",c:"#a78bfa",title:"KI-Empfehlungen",sub:"Personalisiert — jeden Tag neu"},
                {grad:"linear-gradient(135deg,#e8439322,#e8439311)",border:"rgba(232,67,147,0.25)",icon:"🎴",c:"#f472b6",title:"Swipe & Entdecken",sub:"Wie du's von Dating-Apps kennst"},
                {grad:"linear-gradient(135deg,#ff6b3522,#ff6b3511)",border:"rgba(255,107,53,0.25)",icon:"🎭",c:"#fb923c",title:"Lerne deinen Filmtyp",sub:"Die KI analysiert deinen Geschmack"},
              ].map((f,i)=>(
                <div key={i} style={{display:"flex",alignItems:"center",gap:14,background:f.grad,borderRadius:18,padding:"14px 18px",border:"1px solid "+f.border}}>
                  <span style={{fontSize:26,flexShrink:0}}>{f.icon}</span>
                  <div style={{textAlign:"left"}}>
                    <div style={{fontSize:15,fontWeight:800,color:"#f0ece4",marginBottom:2}}>{f.title}</div>
                    <div style={{fontSize:12,color:"#8a849a"}}>{f.sub}</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        {/* Step 1: Anbieter */}
        {step===1&&(
          <div style={{flex:1,padding:"32px 22px 0",overflowY:"auto"}}>
            <div style={{marginBottom:24}}>
              <p style={{fontSize:11,color:"#c4a960",fontWeight:700,textTransform:"uppercase",letterSpacing:2,margin:"0 0 6px"}}>Schritt 1 von 2</p>
              <h2 style={{fontFamily:"'Instrument Serif',serif",fontSize:30,color:"#f0ece4",margin:"0 0 6px",lineHeight:1.1}}>Welche Anbieter nutzt du?</h2>
              <p style={{fontSize:13,color:"#7a7488",margin:0}}>Wähle alle aktiven Abos — später jederzeit änderbar.</p>
            </div>
              ...
              {PLATFORMS.map(p=>{
                ...
                return(
                  <button key={p.id} onClick={()=>togglePlat(p.id)}
                    style={{background:sel?p.color+"18":"rgba(255,255,255,0.04)",border:"2px solid "+(sel?p.color:"rgba(255,255,255,0.08)"),borderRadius:18,padding:"18px 12px",cursor:"pointer",textAlign:"center",transition:"all 0.2s",boxShadow:sel?"0 0 24px "+p.color+"40":"none",position:"relative"}}>
                    {sel&&<div style={{position:"absolute",top:8,right:8,width:18,height:18,borderRadius:9,background:p.color,display:"flex",alignItems:"center",justifyContent:"center"}}>
                      <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="3"><polyline points="20 6 9 17 4 12"/></svg>
                    </div>}
                    <div style={{fontSize:26,fontWeight:900,color:p.color,marginBottom:8}}>{p.icon}</div>
                    <div style={{fontSize:13,fontWeight:700,color:sel?p.color:"#b0a8b8"}}>{p.name}</div>
                  </button>
                );
              })}
            </div>
            <p style={{fontSize:11,color:"#3a3344",textAlign:"center",marginTop:16,marginBottom:8}}>{selPlats.length} ausgewählt</p>
          </div>
        )}
        ...
        {step===2&&(
          <div style={{flex:1,padding:"32px 22px 0",overflowY:"auto"}}>
            <div style={{marginBottom:20}}>
              <p style={{fontSize:11,color:"#c4a960",fontWeight:700,textTransform:"uppercase",letterSpacing:2,margin:"0 0 6px"}}>Schritt 2 von 2</p>
              <h2 style={{fontFamily:"'Instrument Serif',serif",fontSize:30,color:"#f0ece4",margin:"0 0 6px",lineHeight:1.1}}>Was schaust du am liebsten?</h2>
              <p style={{fontSize:13,color:"#7a7488",margin:0}}>Deine Auswahl beeinflusst alle Empfehlungen.</p>
            </div>
              ...
              {STIMMUNGEN.map(m=>{
                ...
                return(
                  <button key={m.id} onClick={()=>toggleStimmung(m.id)}
                    style={{position:"relative",borderRadius:16,overflow:"hidden",cursor:"pointer",border:"2px solid "+(sel?m.color:"transparent"),transition:"all 0.2s",height:90,background:"#0a0a12",boxShadow:sel?"0 0 20px "+m.color+"50":"none",padding:0}}>
                    <img src={m.tmdbImg} alt="" style={{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"center 20%",opacity:sel?0.75:0.35,transition:"opacity 0.2s"}} onError={e=>{e.target.style.display="none";}}/>
                    ...
                    {sel&&<div style={{position:"absolute",top:6,right:6,width:16,height:16,borderRadius:8,background:m.color,display:"flex",alignItems:"center",justifyContent:"center"}}>
                      <svg width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="3.5"><polyline points="20 6 9 17 4 12"/></svg>
                    </div>}
                    <div style={{position:"absolute",bottom:0,left:0,right:0,padding:"6px 6px 8px",textAlign:"center"}}>
            ...
            <p style={{fontSize:11,color:"#3a3344",textAlign:"center",marginTop:12,marginBottom:8}}>{selStimmungen.length} ausgewählt</p>
          </div>
        )}

        {/* Buttons */}
        <div style={{padding:"16px 22px",paddingBottom:"calc(env(safe-area-inset-bottom) + 20px)",display:"flex",gap:10,flexShrink:0}}>
          {step>0&&<button onClick={()=>setStep(s=>s-1)} style={{width:52,height:52,borderRadius:16,background:"rgba(255,255,255,0.06)",border:"1px solid rgba(255,255,255,0.1)",cursor:"pointer",color:"#b0a8b8",fontFamily:"'DM Sans'",fontWeight:700,fontSize:18,flexShrink:0}}>←</button>}
          <button
            onClick={()=>{
            ...
            style={{flex:1,background:step===STEPS_COUNT-1?"linear-gradient(135deg,#c4a960,#ff6b35)":"linear-gradient(135deg,#7c3aed,#e84393)",border:"none",borderRadius:16,padding:"16px",cursor:"pointer",color:"#fff",fontFamily:"'DM Sans'",fontWeight:800,fontSize:16,opacity:step===1&&selPlats.length===0?0.4:1,boxShadow:step===STEPS_COUNT-1?"0 8px 32px rgba(196,169,96,0.4)":"0 8px 32px rgba(124,58,237,0.4)"}}>
            {step===0?"Los geht's →":step===1?"Weiter →":"Erste Titel entdecken 🎴"}
          </button>
        </div>
        ...
        <div style={{display:"flex",gap:5,justifyContent:"center",paddingBottom:16}}>
          {Array.from({length:STEPS_COUNT}).map((_,i)=>(
            <div key={i} style={{width:i===step?24:7,height:7,borderRadius:4,background:i===step?"#e84393":i<step?"#7c3aed40":"#1e1e30",transition:"all 0.3s"}}/>
          ))}
        </div>

        {step===0&&<div style={{textAlign:"center",paddingBottom:20}}>
          <button onClick={skipSwipe} style={{background:"none",border:"none",color:"#3a3344",cursor:"pointer",fontSize:12,fontFamily:"'DM Sans'"}}>Überspringen</button>
        </div>}
      </div>
    </div>
  );
...
function MainApp({initialProfile}){
  ...
  return(
    <div style={{maxWidth:560,margin:"0 auto",minHeight:"100vh",background:"#09090f",position:"relative",fontFamily:"'DM Sans',sans-serif"}}>
      <style>{`
      ...
      <div style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:560,background:"rgba(9,9,15,0.97)",backdropFilter:"blur(24px)",borderTop:"1px solid rgba(255,255,255,0.07)",zIndex:100,padding:"6px 0 calc(env(safe-area-inset-bottom) + 6px)"}}>
