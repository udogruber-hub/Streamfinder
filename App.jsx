                      ...
                      <div style={{flex:1,minWidth:0}}>
                        ...
                        <div style={{display:"flex",gap:6,alignItems:"center",marginBottom:4}}>
                          ...
                          {(()=>{
                            ...
                            const leds=[{v:1,c:"#ef4444"},{v:3,c:"#f97316"},{v:5,c:"#4ade80"}];
                            return <div style={{display:"flex",gap:3,marginLeft:2}}>{leds.map(l=><div key={l.v} onClick={e=>{e.stopPropagation();const newVal=rVal===l.v?0:l.v;onRate(rec.title,newVal,tmdb?.genre_ids||[]);if(newVal===1)replaceRec(rec.title);}} style={{width:8,height:8,borderRadius:"50%",background:rVal===l.v?l.c:"#1e1e30",border:"1px solid "+(rVal===l.v?l.c:"#3a3344"),cursor:"pointer",boxShadow:rVal===l.v?"0 0 6px "+l.c:"none"}}/>)}</div>;
                          })()}
                        </div>
...
function BrowseFeature({mode,profile,cardProps,onSelect}){
  // This renders the existing browse features inline
  return null; // Placeholder - existing browse content renders separately
}
  ...
  return(
    <div style={{minHeight:"100vh",background:"#09090f",color:"#f0ece4",fontFamily:"'DM Sans',sans-serif",paddingBottom:90}}>
      ...
      <div style={{paddingTop:14}}>
        ...
        {tab==="spotlight"&&(
          <div style={{padding:"0 18px"}}>
            <h2 style={{fontFamily:"'Instrument Serif',serif",fontSize:28,margin:"0 0 4px",background:"linear-gradient(135deg,#c4a960,#f0ece4)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>✦ Spotlight</h2>
            <p style={{fontSize:12,color:"#b0a8b8",marginBottom:20}}>Dein persönlicher Assistent für den perfekten Titel.</p>

            {/* Deep Dive — Premium Card */}
            <div onClick={()=>setMode("deepdive")} style={{background:"linear-gradient(135deg,#1a1525,#0f1020)",borderRadius:20,padding:20,marginBottom:12,border:"1px solid rgba(196,169,96,0.2)",cursor:"pointer",display:"flex",gap:16,alignItems:"center"}}>
              <div style={{width:52,height:52,borderRadius:16,background:"linear-gradient(135deg,#c4a960,#8b6914)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,fontSize:24}}>🔭</div>
              <div style={{flex:1}}>
                <div style={{fontSize:17,fontWeight:800,color:"#f0ece4",marginBottom:3}}>Deep Dive</div>
                <div style={{fontSize:12,color:"#b0a8b8",lineHeight:1.4}}>Starte mit einem Lieblingstitel — wir bauen daraus ein ganzes Universum.</div>
              </div>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#c4a960" strokeWidth="2" strokeLinecap="round"><polyline points="9 18 15 12 9 6"/></svg>
            </div>

            {/* Vibe Meter — Premium Card */}
            <div onClick={()=>setMode("vibe")} style={{background:"linear-gradient(135deg,#1a1020,#130818)",borderRadius:20,padding:20,marginBottom:12,border:"1px solid rgba(232,67,147,0.2)",cursor:"pointer",display:"flex",gap:16,alignItems:"center"}}>
              <div style={{width:52,height:52,borderRadius:16,background:"linear-gradient(135deg,#e84393,#7c3aed)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,fontSize:24}}>🎛️</div>
              <div style={{flex:1}}>
                <div style={{fontSize:17,fontWeight:800,color:"#f0ece4",marginBottom:3}}>Vibe-Meter</div>
                <div style={{fontSize:12,color:"#b0a8b8",lineHeight:1.4}}>Stimmung einstellen — wir finden den Titel der genau passt.</div>
              </div>
            ...
            {/* StreamBot — Premium Card */}
            <div onClick={()=>setMode("bot")} style={{background:"linear-gradient(135deg,#0f1a1a,#0d1f1a)",borderRadius:20,padding:20,marginBottom:24,border:"1px solid rgba(74,222,128,0.2)",cursor:"pointer",display:"flex",gap:16,alignItems:"center"}}>
              <div style={{width:52,height:52,borderRadius:16,background:"linear-gradient(135deg,#4ade80,#22d3ee)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,fontSize:24}}>💬</div>
              <div style={{flex:1}}>
                <div style={{fontSize:17,fontWeight:800,color:"#f0ece4",marginBottom:3}}>StreamBot</div>
                <div style={{fontSize:12,color:"#b0a8b8",lineHeight:1.4}}>Einfach fragen — dein persönlicher Streaming-Experte antwortet.</div>
              </div>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4ade80" strokeWidth="2" strokeLinecap="round"><polyline points="9 18 15 12 9 6"/></svg>
            </div>

            {/* KI Mode content */}
            {(mode==="deepdive"||mode==="vibe"||mode==="bot")&&(
              <div style={{marginBottom:24}}>
                <BrowseTab profile={profile} cardProps={cardProps} onSelect={handleSelect} spotlightMode={mode} onModeChange={setMode}/>
              </div>
            )}
            ...
            <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:16}}>
              <div style={{flex:1,height:1,background:"#1e1e30"}}/>
              <span style={{fontSize:10,color:"#3a3344",textTransform:"uppercase",letterSpacing:"1px"}}>Extras</span>
              <div style={{flex:1,height:1,background:"#1e1e30"}}/>
            </div>

            <div style={{background:"#12121f",borderRadius:16,padding:16,marginBottom:10,border:"1px solid #1e1e30",textAlign:"center"}}>
              <div style={{fontSize:28,marginBottom:6}}>🎲</div>
              <h3 style={{fontFamily:"'Instrument Serif',serif",fontSize:17,margin:"0 0 4px",color:"#f0ece4"}}>Überrasch mich!</h3>
              <p style={{fontSize:12,color:"#a09aaa",marginBottom:12}}>Wir entscheiden. Du schaust.</p>
            ...
            <div style={{background:"#12121f",borderRadius:16,padding:16,marginBottom:10,border:"1px solid #1e1e30",textAlign:"center"}}>
              <div style={{fontSize:28,marginBottom:6}}>🔮</div>
              <h3 style={{fontFamily:"'Instrument Serif',serif",fontSize:17,margin:"0 0 4px",color:"#d4b8f0"}}>Das Orakel</h3>
              <p style={{fontSize:12,color:"#a09aaa",marginBottom:12}}>Mystischer. Unabhängig vom Würfel.</p>
            ...
            <div style={{background:"#12121f",borderRadius:16,padding:16,border:"1px solid #1e1e30"}}>
              <div style={{fontSize:28,marginBottom:6,textAlign:"center"}}>🧠</div>
              <h3 style={{fontFamily:"'Instrument Serif',serif",fontSize:17,margin:"0 0 4px",color:"#a0f0c8",textAlign:"center"}}>Dein Streaming-Typ</h3>
              <p style={{fontSize:12,color:"#a09aaa",marginBottom:12,textAlign:"center"}}>Wir analysieren deinen Geschmack.</p>
